export const shortenFileName = (str, maxLength, ellipsisLocationPercentage, placeholder) => {
  if(str) {
...
export const shortenFileNameWithEnd = (str, maxLength, ellipsisLocationPercentage, placeholder) => {
  if(str) {
     if(ellipsisLocationPercentage == null || isNaN(ellipsisLocationPercentage) || ellipsisLocationPercentage >= 1 || ellipsisLocationPercentage <= 0){
       ellipsisLocationPercentage = .85;
     }
