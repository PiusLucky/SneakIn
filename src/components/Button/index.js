...
import { StarActivateButton } from "../Themefy/CustomTheme"
class Button extends Component {
    render() {
        const { channelSwitcher, channelType } = this.props
        return (
            <>
            <StarActivateButton className="activate" onClick={() => channelSwitcher(channelType)} >
              <span>
                <svg>
